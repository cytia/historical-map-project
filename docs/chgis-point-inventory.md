...
项目共有 1,641 个地点记录。云贵试点前，实际采用 CHGIS 坐标的地点为 1,147 个，占全部地点 69.9%；其中 `jiangxi-jian-yongfeng-seat` 明确记录 CHGIS 在 1600 年无命中并保留现代代理，因此不计入该基线。完成云贵 14 点、福建 47 点和江西 64 点替换后，当前仍由 CHGIS `location` 主张承担坐标的地点为 **1,022 个，占全部地点 62.3%**。

迁移前基线涉及 1,139 个唯一 CHGIS `hvd_*` 编号和 1,125 组唯一坐标；当前未迁移记录涉及 **1,012 个唯一编号**和 **1,000 组唯一坐标**。迁移前有 21 组坐标由多个地点记录共用，共涉及 43 个地点；4 个地点同时引用多个 CHGIS 编号；12 个 CHGIS 编号被多个项目地点记录复用。

当前未迁移记录的定位精度为 `approximate` 1,022；可信度为 `medium` 1,014、`low` 8。
...
| 府与直隶州治所 | 67 | 在所属区域批次中优先复核 |
| 府属州与县治 | 946 | 随所属区域一并替换 |
| 特殊治理／军事节点 | 4 | 单独研究与复核 |
| 合计 | 1,022 | |
...
4. **其余区域分批替换。** 默认按当前点位数量由少到多安排：浙江 72 → 陕西 73／广东 73 → 广西 82 → 山西 88 → 四川 90 → 河南 97 → 山东 104 → 湖广 107 → 南京 115 → 京师 121。
...
以下清单按一级行政区域、行政层级分类和行政单位名称排序。除已标注“已独立替换（云贵试点）”的 14 条、“已独立替换（福建试验）”的 47 条和“已独立替换（江西压力测试）”的 64 条记录外，其余记录当前状态均为“待独立替换”。
...
| 979 | 广东 | 府与直隶州治所 | 廉州府／合浦县 | prefecture／county | `hepu-seat` | `hvd_42526`／`hvd_33011` | `approximate`／`medium` | 关联 2 个行政实体；多编号 2；待独立替换 |
| 980 | 广东 | 府与直隶州治所 | 琼州府／琼山县 | prefecture／county | `qiongshan-seat` | `hvd_42455`／`hvd_33070` | `approximate`／`medium` | 关联 2 个行政实体；多编号 2；待独立替换 |
| 981 | 广东 | 府属州与县治 | 安定县 | county | `anding-qiongzhou-seat` | `hvd_121106` | `approximate`／`low` | 低可信；待独立替换 |
| 982 | 广东 | 府属州与县治 | 博罗县 | county | `boluo-huizhou-seat` | `hvd_42171` | `approximate`／`medium` | 待独立替换 |
| 983 | 广东 | 府属州与县治 | 昌化县 | county | `changhua-danzhou-seat` | `hvd_42482` | `approximate`／`medium` | 待独立替换 |
| 984 | 广东 | 府属州与县治 | 潮阳县 | county | `chaoyang-chaozhou-seat` | `hvd_42146` | `approximate`／`medium` | 待独立替换 |
| 985 | 广东 | 府属州与县治 | 程乡县 | county | `chengxiang-chaozhou-seat` | `hvd_42576` | `approximate`／`medium` | 待独立替换 |
| 986 | 广东 | 府属州与县治 | 澄海县 | county | `chenghai-chaozhou-seat` | `hvd_42156` | `approximate`／`medium` | 待独立替换 |
| 987 | 广东 | 府属州与县治 | 澄迈县 | county | `chengmai-qiongzhou-seat` | `hvd_42456` | `approximate`／`medium` | 待独立替换 |
| 988 | 广东 | 府属州与县治 | 从化县 | county | `conghua-guangzhou-seat` | `hvd_42209` | `approximate`／`medium` | 待独立替换 |
| 989 | 广东 | 府属州与县治 | 大埔县 | county | `dabu-chaozhou-seat` | `hvd_42155` | `approximate`／`medium` | 待独立替换 |
| 990 | 广东 | 府属州与县治 | 儋州 | department | `dan-qiongzhou-seat` | `hvd_42477` | `approximate`／`medium` | 待独立替换 |
| 991 | 广东 | 府属州与县治 | 德庆州 | department | `deqing-zhaoqing-seat` | `hvd_42353` | `approximate`／`medium` | 待独立替换 |
| 992 | 广东 | 府属州与县治 | 电白县 | county | `dianbai-gaozhou-seat` | `hvd_42386` | `approximate`／`medium` | 待独立替换 |
| 993 | 广东 | 府属州与县治 | 东安州 | department | `dongan-luoding-seat` | `hvd_42624` | `approximate`／`medium` | 待独立替换 |
| 994 | 广东 | 府属州与县治 | 东莞县 | county | `dongguan-guangzhou-seat` | `hvd_42205` | `approximate`／`medium` | 待独立替换 |
| 995 | 广东 | 府属州与县治 | 恩平县 | county | `enping-zhaoqing-seat` | `hvd_42331` | `approximate`／`medium` | 待独立替换 |
| 996 | 广东 | 府属州与县治 | 封川县 | county | `fengchuan-deqing-seat` | `hvd_42373` | `approximate`／`medium` | 待独立替换 |
| 997 | 广东 | 府属州与县治 | 感恩县 | county | `ganen-yazhou-seat` | `hvd_121115` | `approximate`／`low` | 低可信；待独立替换 |
| 998 | 广东 | 府属州与县治 | 高明县 | county | `gaoming-zhaoqing-seat` | `hvd_42325` | `approximate`／`medium` | 待独立替换 |
| 999 | 广东 | 府属州与县治 | 广宁县 | county | `guangning-zhaoqing-seat` | `hvd_42339` | `approximate`／`medium` | 待独立替换 |
| 1000 | 广东 | 府属州与县治 | 海丰县 | county | `haifeng-huizhou-seat` | `hvd_42180` | `approximate`／`medium` | 待独立替换 |
| 1001 | 广东 | 府属州与县治 | 和平县 | county | `heping-huizhou-seat` | `hvd_42192` | `approximate`／`medium` | 待独立替换 |
| 1002 | 广东 | 府属州与县治 | 河源县 | county | `heyuan-huizhou-seat` | `hvd_42190` | `approximate`／`medium` | 待独立替换 |
| 1003 | 广东 | 府属州与县治 | 化州 | department | `huazhou-gaozhou-seat` | `hvd_42407` | `approximate`／`medium` | 待独立替换 |
| 1004 | 广东 | 府属州与县治 | 会同县 | county | `huitong-qiongzhou-seat` | `hvd_42462` | `approximate`／`medium` | 待独立替换 |
| 1005 | 广东 | 府属州与县治 | 惠来县 | county | `huilai-chaozhou-seat` | `hvd_42152` | `approximate`／`medium` | 待独立替换 |
| 1006 | 广东 | 府属州与县治 | 揭阳县 | county | `jieyang-chaozhou-seat` | `hvd_42149` | `approximate`／`medium` | 待独立替换 |
| 1007 | 广东 | 府属州与县治 | 开建县 | county | `kaijian-deqing-seat` | `hvd_42375` | `approximate`／`medium` | 待独立替换 |
| 1008 | 广东 | 府属州与县治 | 乐昌县 | county | `lechang-shaozhou-seat` | `hvd_42243` | `approximate`／`medium` | 待独立替换 |
| 1009 | 广东 | 府属州与县治 | 乐会县 | county | `lehui-qiongzhou-seat` | `hvd_42468` | `approximate`／`medium` | 待独立替换 |
| 1010 | 广东 | 府属州与县治 | 连山县 | county | `lianshan-lianzhou-seat` | `hvd_42614` | `approximate`／`medium` | 待独立替换 |
| 1011 | 广东 | 府属州与县治 | 连州 | department | `lianzhou-guangzhou-seat` | `hvd_42620` | `approximate`／`medium` | 待独立替换 |
| 1012 | 广东 | 府属州与县治 | 临高县 | county | `lingao-qiongzhou-seat` | `hvd_42471` | `approximate`／`medium` | 待独立替换 |
| 1013 | 广东 | 府属州与县治 | 灵山县 | county | `lingshan-qinzhou-seat` | `hvd_42569` | `approximate`／`medium` | 待独立替换 |
| 1014 | 广东 | 府属州与县治 | 陵水县 | county | `lingshui-wanzhou-seat` | `hvd_42500` | `approximate`／`medium` | 待独立替换 |
| 1015 | 广东 | 府属州与县治 | 龙川县 | county | `longchuan-huizhou-seat` | `hvd_42188` | `approximate`／`medium` | 待独立替换 |
| 1016 | 广东 | 府属州与县治 | 龙门县 | county | `longmen-guangzhou-seat` | `hvd_42210` | `approximate`／`medium` | 待独立替换 |
| 1017 | 广东 | 府属州与县治 | 平远县 | county | `pingyuan-chaozhou-seat` | `hvd_42588` | `approximate`／`medium` | 待独立替换 |
| 1018 | 广东 | 府属州与县治 | 普宁县 | county | `puning-chaozhou-seat` | `hvd_42160` | `approximate`／`medium` | 待独立替换 |
| 1019 | 广东 | 府属州与县治 | 钦州 | department | `qinzhou-lianzhou-seat` | `hvd_320` | `approximate`／`low` | 低可信；待独立替换 |
| 1020 | 广东 | 府属州与县治 | 清远县 | county | `qingyuan-guangzhou-seat` | `hvd_42232` | `approximate`／`medium` | 待独立替换 |
| 1021 | 广东 | 府属州与县治 | 饶平县 | county | `raoping-chaozhou-seat` | `hvd_42150` | `approximate`／`medium` | 待独立替换 |
| 1022 | 广东 | 府属州与县治 | 仁化县 | county | `renhua-shaozhou-seat` | `hvd_42247` | `approximate`／`medium` | 待独立替换 |
| 1023 | 广东 | 府属州与县治 | 乳源县 | county | `ruyuan-shaozhou-seat` | `hvd_42249` | `approximate`／`medium` | 待独立替换 |
| 1024 | 广东 | 府属州与县治 | 三水县 | county | `sanshui-guangzhou-seat` | `hvd_42227` | `approximate`／`medium` | 待独立替换 |
| 1025 | 广东 | 府属州与县治 | 石城县 | county | `shicheng-huazhou-seat` | `hvd_42420` | `approximate`／`medium` | 待独立替换 |
| 1026 | 广东 | 府属州与县治 | 始兴县 | county | `shixing-nanxiong-seat` | `hvd_42596` | `approximate`／`medium` | 待独立替换 |
| 1027 | 广东 | 府属州与县治 | 顺德县 | county | `shunde-guangzhou-seat` | `hvd_42202` | `approximate`／`medium` | 待独立替换 |
| 1028 | 广东 | 府属州与县治 | 四会县 | county | `sihui-zhaoqing-seat` | `hvd_42270` | `approximate`／`medium` | 待独立替换 |
| 1029 | 广东 | 府属州与县治 | 遂溪县 | county | `suixi-leizhou-seat` | `hvd_42441` | `approximate`／`medium` | 待独立替换 |
| 1030 | 广东 | 府属州与县治 | 万州 | department | `wanzhou-qiongzhou-seat` | `hvd_42491` | `approximate`／`medium` | 待独立替换 |
| 1031 | 广东 | 府属州与县治 | 文昌县 | county | `wenchang-qiongzhou-seat` | `hvd_42451` | `approximate`／`medium` | 待独立替换 |
| 1032 | 广东 | 府属州与县治 | 翁源县 | county | `wengyuan-shaozhou-seat` | `hvd_42255` | `approximate`／`medium` | 待独立替换 |
| 1033 | 广东 | 府属州与县治 | 吴川县 | county | `wuchuan-huazhou-seat` | `hvd_42414` | `approximate`／`medium` | 待独立替换 |
| 1034 | 广东 | 府属州与县治 | 西宁州 | department | `xining-luoding-seat` | `hvd_42646` | `approximate`／`medium` | 待独立替换 |
| 1035 | 广东 | 府属州与县治 | 香山县 | county | `xiangshan-guangzhou-seat` | `hvd_42226` | `approximate`／`medium` | 待独立替换 |
| 1036 | 广东 | 府属州与县治 | 新安县 | county | `xinan-guangzhou-seat` | `hvd_42206` | `approximate`／`medium` | 待独立替换 |
| 1037 | 广东 | 府属州与县治 | 新会县 | county | `xinhui-guangzhou-seat` | `hvd_42218` | `approximate`／`medium` | 待独立替换 |
| 1038 | 广东 | 府属州与县治 | 新宁县 | county | `xinning-guangzhou-seat` | `hvd_42228` | `approximate`／`medium` | 待独立替换 |
| 1039 | 广东 | 府属州与县治 | 新兴县 | county | `xinxing-zhaoqing-seat` | `hvd_42284` | `approximate`／`medium` | 待独立替换 |
| 1040 | 广东 | 府属州与县治 | 信宜县 | county | `xinyi-gaozhou-seat` | `hvd_42402` | `approximate`／`medium` | 待独立替换 |
| 1041 | 广东 | 府属州与县治 | 兴宁县 | county | `xingning-huizhou-seat` | `hvd_42582` | `approximate`／`medium` | 待独立替换 |
| 1042 | 广东 | 府属州与县治 | 徐闻县 | county | `xuwen-leizhou-seat` | `hvd_42431` | `approximate`／`medium` | 待独立替换 |
| 1043 | 广东 | 府属州与县治 | 崖州 | department | `yazhou-qiongzhou-seat` | `hvd_337` | `approximate`／`low` | 低可信；待独立替换 |
| 1044 | 广东 | 府属州与县治 | 阳春县 | county | `yangchun-zhaoqing-seat` | `hvd_42291` | `approximate`／`medium` | 待独立替换 |
| 1045 | 广东 | 府属州与县治 | 阳江县 | county | `yangjiang-zhaoqing-seat` | `hvd_42304` | `approximate`／`medium` | 待独立替换 |
| 1046 | 广东 | 府属州与县治 | 阳山县 | county | `yangshan-lianzhou-seat` | `hvd_42603` | `approximate`／`medium` | 待独立替换 |
| 1047 | 广东 | 府属州与县治 | 英德县 | county | `yingde-shaozhou-seat` | `hvd_42263` | `approximate`／`medium` | 待独立替换 |
| 1048 | 广东 | 府属州与县治 | 永安县 | county | `yongan-huizhou-seat` | `hvd_42179` | `approximate`／`medium` | 待独立替换 |
| 1049 | 广东 | 府属州与县治 | 增城县 | county | `zengcheng-guangzhou-seat` | `hvd_42214` | `approximate`／`medium` | 待独立替换 |
| 1050 | 广东 | 府属州与县治 | 长乐县 | county | `changle-huizhou-seat` | `hvd_42587` | `approximate`／`medium` | 待独立替换 |
| 1051 | 广东 | 府属州与县治 | 长宁县 | county | `changning-huizhou-seat` | `hvd_42178` | `approximate`／`medium` | 待独立替换 |
